...
wget -nc https://www.kernel.org/pub/software/utils/pciutils/pciutils-3.5.6.tar.xz
...
wget -nc https://github.com/p11-glue/p11-kit/releases/download/0.23.9/p11-kit-0.23.9.tar.gz
...
wget -nc https://sourceware.org/ftp/lvm2/releases/LVM2.2.02.177.tgz
...
wget -nc https://cmake.org/files/v3.10/cmake-3.10.1.tar.gz
