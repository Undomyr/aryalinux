...
wget -nc https://ftp.osuosl.org/pub/blfs/conglomeration/gnutls/gnutls-3.4.3.tar.xz
...
wget -nc https://www.kernel.org/pub/linux/utils/boot/dracut/dracut-046.tar.xz
