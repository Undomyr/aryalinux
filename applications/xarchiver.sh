...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/xarchiver-0.5.4-fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/xarchiver/xarchiver-0.5.4-fixes-1.patch
