...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/wpa_supplicant-2.6-upstream_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/wpa_supplicant/wpa_supplicant-2.6-upstream_fixes-1.patch
