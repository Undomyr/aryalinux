...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/clisp-2.49-readline7_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/clisp/clisp-2.49-readline7_fixes-1.patch
