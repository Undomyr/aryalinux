...
wget -nc http://www.linuxfromscratch.org/patches/blfs/svn/libxml2-2.9.7-python3_hack-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/libxml2/libxml2-2.9.7-python3_hack-1.patch
