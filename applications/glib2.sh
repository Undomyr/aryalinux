...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/glib-2.54.3-meson_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/glib/glib-2.54.3-meson_fixes-1.patch
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/glib-2.54.3-skip_warnings-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/glib/glib-2.54.3-skip_warnings-1.patch
