...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/clucene-2.3.3.4-contribs_lib-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/clucene/clucene-2.3.3.4-contribs_lib-1.patch
