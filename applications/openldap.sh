...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/openldap-2.4.45-consolidated-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/openldap/openldap-2.4.45-consolidated-1.patch
