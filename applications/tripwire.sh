...
if [ ! -z $URL ]
then
wget -nc https://github.com/Tripwire/tripwire-open-source/releases/download/2.4.3.5/tripwire-open-source-2.4.3.5.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/tripwire/tripwire-open-source-2.4.3.5.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/tripwire/tripwire-open-source-2.4.3.5.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/tripwire/tripwire-open-source-2.4.3.5.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/tripwire/tripwire-open-source-2.4.3.5.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/tripwire/tripwire-open-source-2.4.3.5.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/tripwire/tripwire-open-source-2.4.3.5.tar.gz
