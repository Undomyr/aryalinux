...
wget -nc http://www.linuxfromscratch.org/patches/blfs/svn/openssh-7.6p1-openssl-1.1.0-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/openssh/openssh-7.6p1-openssl-1.1.0-1.patch
