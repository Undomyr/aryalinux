...
SOURCE_ONLY=n
DESCRIPTION="br3ak The Gtkmm package provides a C++br3ak interface to GTK+ 2. It can bebr3ak installed alongside <a class=\"xref\" href=\"gtkmm3.html\" title=\"Gtkmm-3.22.1\">Gtkmm-3.22.1</a> (the GTK+br3ak 3 version) with no namespace conflicts.br3ak"
SECTION="x"
VERSION=2.24.5
NAME="gtkmm2"
