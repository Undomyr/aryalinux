...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/mupdf-1.12.0-consolidated_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/mupdf/mupdf-1.12.0-consolidated_fixes-1.patch
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/mupdf-1.12.0-security_fix-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/mupdf/mupdf-1.12.0-security_fix-1.patch
