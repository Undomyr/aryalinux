...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/itstool-2.0.4-segfault-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/itstool/itstool-2.0.4-segfault-1.patch
