...
if [ ! -z $URL ]
then
wget -nc https://xkbcommon.org/download/libxkbcommon-0.7.2.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libxkbcommon/libxkbcommon-0.7.2.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libxkbcommon/libxkbcommon-0.7.2.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libxkbcommon/libxkbcommon-0.7.2.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libxkbcommon/libxkbcommon-0.7.2.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libxkbcommon/libxkbcommon-0.7.2.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libxkbcommon/libxkbcommon-0.7.2.tar.xz
