...
if [ ! -z $URL ]
then
wget -nc http://ffmpeg.org/releases/ffmpeg-3.4.1.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/ffmpeg/ffmpeg-3.4.1.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/ffmpeg/ffmpeg-3.4.1.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/ffmpeg/ffmpeg-3.4.1.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/ffmpeg/ffmpeg-3.4.1.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/ffmpeg/ffmpeg-3.4.1.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/ffmpeg/ffmpeg-3.4.1.tar.xz
...
./configure --prefix=/usr        \
            ...
            --enable-libx264     \
            --enable-libx265     \
            --docdir=/usr/share/doc/ffmpeg-3.4.1 &&
make &&
...
install -v -m755 -d           /usr/share/doc/ffmpeg-3.4.1 &&
install -v -m644    doc/*.txt /usr/share/doc/ffmpeg-3.4.1
