...
SOURCE_ONLY=n
DESCRIPTION="br3ak The rpcsvc-proto package containsbr3ak the rcpsvc protocol.x files and headers, formerly included withbr3ak GlibC, that are not included in replacement <a class=\"xref\" href=\"libtirpc.html\" title=\"libtirpc-1.0.2\">libtirpc-1.0.2</a>, alongbr3ak with the rpcgen program.br3ak"
SECTION="basicnet"
VERSION=1.3.1
NAME="rpcsvc-proto"
