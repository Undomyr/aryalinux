...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/libmad-0.15.1b-fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/libmad/libmad-0.15.1b-fixes-1.patch
