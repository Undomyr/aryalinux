...
URL=http://www.jwz.org/xscreensaver/xscreensaver-5.37.tar.gz

if [ ! -z $URL ]
then
wget -nc http://www.jwz.org/xscreensaver/xscreensaver-5.37.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/xscreensaver/xscreensaver-5.37.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/xscreensaver/xscreensaver-5.37.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/xscreensaver/xscreensaver-5.37.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/xscreensaver/xscreensaver-5.37.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/xscreensaver/xscreensaver-5.37.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/xscreensaver/xscreensaver-5.37.tar.gz
