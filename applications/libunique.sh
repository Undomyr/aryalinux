...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/libunique-1.1.6-upstream_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/libunique/libunique-1.1.6-upstream_fixes-1.patch
