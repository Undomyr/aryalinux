...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/lua-5.3.4-shared_library-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/lua/lua-5.3.4-shared_library-1.patch
