...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.1/libquicktime-1.2.4-ffmpeg3-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/libquicktime/libquicktime-1.2.4-ffmpeg3-1.patch
