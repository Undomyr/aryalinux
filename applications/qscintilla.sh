...
URL=https://downloads.sourceforge.net/pyqt/QScintilla_gpl-2.10.2.tar.gz

if [ ! -z $URL ]
then
wget -nc https://downloads.sourceforge.net/pyqt/QScintilla_gpl-2.10.2.tar.gz
...
make install &&
ln -sfv libqscintilla2_qt5.so.13.1.0 /opt/qt5/lib/libqt5scintilla2.so
...
sudo tee rootscript.sh << "ENDOFROOTSCRIPT"
install -v -m755 -d /opt/qt5/share/doc/QScintilla-2.10.2/html &&
install -v -m644    ../doc/html-Qt4Qt5/* \
                    /opt/qt5/share/doc/QScintilla-2.10.2/html
