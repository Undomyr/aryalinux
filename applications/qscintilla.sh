...
URL=https://downloads.sourceforge.net/pyqt/QScintilla_gpl-2.10.1.tar.gz

if [ ! -z $URL ]
then
wget -nc https://downloads.sourceforge.net/pyqt/QScintilla_gpl-2.10.1.tar.gz
...
sudo tee rootscript.sh << "ENDOFROOTSCRIPT"
install -v -m755 -d /opt/qt5/share/doc/QScintilla-2.10.1/html &&
install -v -m644    ../doc/html-Qt4Qt5/* \
                    /opt/qt5/share/doc/QScintilla-2.10.1/html
