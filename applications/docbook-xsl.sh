...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/docbook-xsl-1.79.2-stack_fix-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/docbook-xsl/docbook-xsl-1.79.2-stack_fix-1.patch
