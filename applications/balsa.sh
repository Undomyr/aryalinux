...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/balsa-2.5.3-openssl-1.1.0-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/balsa/balsa-2.5.3-openssl-1.1.0-1.patch
