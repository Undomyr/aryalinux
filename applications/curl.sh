...
if [ ! -z $URL ]
then
wget -nc https://curl.haxx.se/download/curl-7.55.1.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/curl/curl-7.55.1.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/curl/curl-7.55.1.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/curl/curl-7.55.1.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/curl/curl-7.55.1.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/curl/curl-7.55.1.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/curl/curl-7.55.1.tar.xz
