...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.2/gptfdisk-1.0.3-convenience-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/gptfdisk/gptfdisk-1.0.3-convenience-1.patch
