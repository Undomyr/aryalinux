...
wget -nc http://www.linuxfromscratch.org/patches/blfs/svn/transmission-2.92-openssl-1.1.0-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/transmission/transmission-2.92-openssl-1.1.0-1.patch
